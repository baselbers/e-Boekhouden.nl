...
if (!class_exists("Eboekhouden_Menus")) {
    ...
    class Eboekhouden_Menus {
        ...
        public function ebh_admin_menus() {            
            add_menu_page('e-Boekhouden.nl', 'e-Boekhouden.nl', 'manage_options', 'e-boekhouden', array($this, 'ebh_intro_page'), EBOEKHOUDEN_URL_ASSETS . 'images/ebh_icon.png');
            add_submenu_page('e-boekhouden', __('Orders', 'eboekhouden'), __('Orders', 'eboekhouden'), 'manage_options', 'eboekhouden-orders', array($this, 'ebh_orders_page'));
            remove_submenu_page( 'e-boekhouden', 'e-boekhouden');
            add_submenu_page('e-boekhouden', __('Products', 'eboekhouden'), __('Products', 'eboekhouden'), 'manage_options', 'eboekhouden-products', array($this, 'ebh_products_page'));
...
/* Disabled: iFrame to 'eboekhouden' is NOT "allowed" >> "consult" with eboekhouden if they can 'allow' it */
            ...
            add_submenu_page('e-boekhouden', __('Settings', 'eboekhouden'), __('Settings', 'eboekhouden'), 'manage_options', 'eboekhouden-settings', array($this, 'ebh_settings_page'));
            
            if (defined('EBOEKHOUDEN_DEBUG')) {
                add_submenu_page('e-boekhouden', __('Logs', 'eboekhouden'), __('Logs', 'eboekhouden'), 'manage_options', 'eboekhouden-logs', array($this, 'ebh_logs_page'));
            }
            
            add_submenu_page('e-boekhouden', __('Help', 'eboekhouden'), __('Help', 'eboekhouden'), 'manage_options', 'eboekhouden-help', array($this, 'ebh_help_page'));
