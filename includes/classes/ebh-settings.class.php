...
//        private $Eboekhouden_Debug;
        ...
        function __construct() {            // ?? add 'skip_init_hooks' 
        ...
        public function ebh_settings_init() {
            ...
            /** General settings: **/
            add_settings_section('ebh_plugin_settings_section_general', __('General settings', 'eboekhouden'), array($this, 'ebh_settings_section_callback'), 'ebh_settings_general');
            add_settings_field('ebh_payment_term', __('Term of Payment', 'eboekhouden'), array($this, 'ebh_setting_general'), 'ebh_settings_general', 'ebh_plugin_settings_section_general', array('name' => 'ebh_payment_term'));
            add_settings_field('ebh_order_list_max', __('Max. orders per page', 'eboekhouden'), array($this, 'ebh_setting_general'), 'ebh_settings_general', 'ebh_plugin_settings_section_general', array('name' => 'ebh_order_list_max'));
            ...
            add_settings_field('ebh_shippingcost_largenumber', __('Shipping Costs Large Number', 'eboekhouden'), array($this, 'ebh_setting_largenumbers'), 'ebh_settings_largenumbers', 'ebh_plugin_settings_section_largenumbers',  array('name' => 'ebh_shippingcost_largenumber'));
            add_settings_field('ebh_paymentcost_largenumber', __('Payment Costs Large Number', 'eboekhouden'), array($this, 'ebh_setting_largenumbers'), 'ebh_settings_largenumbers', 'ebh_plugin_settings_section_largenumbers', array('name' => 'ebh_paymentcost_largenumber'));             
            add_settings_field('ebh_refund_largenumber', __('Refund Large Number', 'eboekhouden'), array($this, 'ebh_setting_largenumbers'), 'ebh_settings_largenumbers', 'ebh_plugin_settings_section_largenumbers', array('name' => 'ebh_refund_largenumber'));           
            
            /** License settings: **/
            add_settings_section('ebh_plugin_settings_section_license', __('License', 'eboekhouden'), array($this, 'ebh_settings_section_callback'), 'ebh_settings_license');
            add_settings_field('ebh_username', __('Username', 'eboekhouden'), array($this, 'ebh_setting_license'), 'ebh_settings_license', 'ebh_plugin_settings_section_license', array('name' => 'ebh_username'));
            add_settings_field('ebh_security_code_1', __('Security Code #1', 'eboekhouden'), array($this, 'ebh_setting_license'), 'ebh_settings_license', 'ebh_plugin_settings_section_license', array('name' => 'ebh_security_code_1'));
            add_settings_field('ebh_security_code_2', __('Security Code #2', 'eboekhouden'), array($this, 'ebh_setting_license'), 'ebh_settings_license', 'ebh_plugin_settings_section_license', array('name' => 'ebh_security_code_2'));            
            
            /** Advanced settings: */
            add_settings_section('ebh_plugin_settings_section_advanced', __('Advanced settings', 'eboekhouden'), array($this, 'ebh_settings_section_callback'), 'ebh_settings_advanced');            
            add_settings_field('ebh_debug', __('Enabled debug / logging', 'eboekhouden'), array($this, 'ebh_settings_advanced'), 'ebh_settings_advanced', 'ebh_plugin_settings_section_advanced', array('name' => 'ebh_debug'));
            add_settings_field('ebh_log_directory', __('Log file directory', 'eboekhouden'), array($this, 'ebh_settings_advanced'), 'ebh_settings_advanced', 'ebh_plugin_settings_section_advanced', array('name' => 'ebh_log_directory'));
            add_settings_field('ebh_curl_timeout', __('Curl Timeout', 'eboekhouden'), array($this, 'ebh_settings_advanced'), 'ebh_settings_advanced', 'ebh_plugin_settings_section_advanced', array('name' => 'ebh_curl_timeout'));
